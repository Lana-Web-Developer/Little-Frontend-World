...
-Прилагаю скриншоты: 1. ![Главный экран](screenshots/Главный_экран.png) 2. ![Слайдер](screenshots/Слайдер.png) 3. ![Флип-карты](screenshots/Флип_карты.png) 4.![Форма](screenshots/Форма.png).(см. в папке screenshots в проекте);
